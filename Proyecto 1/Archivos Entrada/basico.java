...
void main(){
    ...
    val3 = (pow(8,3) * pow(8,2) - sqrt(4) + tan(12) + sin(60) + 2*cos(60)) / 3; //10922.353109816746   //10923
    double val4 = val1 - val2 + val3; //El resultado es 144916.05150116314
    int resultado = toInt(val4);  //144916  //144917
    if(resultado == 144916 || resultado == 144917){
...
/*
El valor defecto de declaracion es 0 = 0
El valor defecto de asignacion es 0 = 0 y de aritmeticas 0 = 0
Probando Manejo de Entornos
El valor de var1 global es 10=10
El valor de var1 local es 25
Declaraciones 1
Asignaciones 1
Aritmeticas 100
